...
var _sliderbox = document.createElement('div');
...
document.querySelector('#_sliderbox').appendChild(_slider); //make the frog button moooove, ie jump, for now.
//doing this w. flex, justify-content 

var isSelected = false; //refactor into array w. chosen true/false-selections retrieved from localStorage
